(function (window) {
  ...
  class DatabaseModel {
    constructor(config) {
      this.config = config || {};
      this.sessionKey = this.config.SESSION_STORAGE_KEY || 'srm_documents_session_v3';
      this.lastClientKey = this.config.LAST_CLIENT_KEY || 'srm_documents_last_client_v3';
      this.localDatabaseKey = this.config.LOCAL_DATABASE_KEY || 'srm_documents_local_database_v3';
