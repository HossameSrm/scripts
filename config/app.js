(function () {
  ...
  window.APP_CONFIG = Object.freeze({
    ...
    SESSION_STORAGE_KEY: 'srm_documents_session_v5',
    LAST_CLIENT_KEY: 'srm_documents_last_client_v5',
    LOCAL_DATABASE_KEY: 'srm_documents_local_database_v5',
    LOCAL_DATABASE_VERSION: 5,
